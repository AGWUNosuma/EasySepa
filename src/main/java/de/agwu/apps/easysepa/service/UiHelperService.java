...
/**
 * Service for UI helper functions
 */
public class UiHelperService {
    ...
    private void validateField(TextField textField, SepaField field) {
        ...
        if (fieldName.contains("iban")) {
            result = validationService.validateIBAN(value);
        } else if (fieldName.contains("bic")) {
            result = validationService.validateBIC(value);
        } else if (fieldName.contains("amount")) {
            result = validationService.validateAmount(value);
        } else if (fieldName.contains("creditorid")) {
            result = validationService.validateCreditorId(value);
            ...
            result = ValidationService.ValidationResult.success();
        }
